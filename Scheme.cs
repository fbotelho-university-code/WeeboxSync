...
namespace WeeboxSync {
    ...
    public class Scheme {
        ...
        public string origem;  // file de origem , mais fácil de comparar 
        ...
        override public bool Equals(Object n) {
            ...
            Scheme s = (Scheme )n;
            return (this.id.Equals(s.arvore) && this.origem.Equals(s.origem) && this.arvore.Equals(s.arvore) && this.arvoreByWeeboxIds.Equals(s.arvoreByWeeboxIds)); 
        }
    }
}
